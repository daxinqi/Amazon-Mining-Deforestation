...
**Overview:**
By now, the two issues of CO2 emission, and deforestation have become global issues, catching the attention of many consumers and companies with devestating effects such as trading limitations, damage by severe weather, and crop failure arising from droughts and atomospherical convection shifts amongst many other climactic effects.
...
So, what’s going on in the atmosphere? Convection currents are natural cycles that move heat around in the air, ocean, and even the Earth’s mantle. Here’s how it works: air near a heat source warms up, becomes less dense, and rises. As it gets higher, it cools, becomes denser, and sinks back down. This process keeps repeating. When the heat source gets hotter, it speeds up the cycle, making the air move more intensely.
...
In this project we utilized Earthrise ENterprise's [Mining detector model](https://github.com/earthrise-media/mining-detector) To correlate mining in the Amazon Rainforest with the
