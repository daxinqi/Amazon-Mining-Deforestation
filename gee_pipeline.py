...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--region_path",
        default='../data/boundaries/test_region.geojson',
        type=str, help="Path to ROI geojson")
    parser.add_argument(
        "--start_date", default='2022-01-01', type=valid_datetime,
        help="Start date in YYYY-MM-DD format")
    parser.add_argument(
        "--end_date", default='2022-12-31', type=valid_datetime,
        help="End date in YYYY-MM-DD format")
    parser.add_argument(
        "--pred_threshold", default=0.1, type=float,
